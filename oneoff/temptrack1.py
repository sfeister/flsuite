...
# -*- coding: utf-8 -*-
"""
temptrack1.py: Track the temperature evolution through time in two simulations

Created by Scott Feister on Wed Dec 14 15:22:10 2016

USAGE:
mpirun -np 12 python temptrack1.py

CHANGELOG:
2016-12-14 Created, based loosely on magtrack3.py
...
if __name__ == "__main__":
    ...
    # hdf5_plt_cnt_??[0,5]0
    outroot=r'/home/sfeister/myouts/dec2016_NIF_comparison'
