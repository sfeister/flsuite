...
def anlzD(ds, outdir='.'):
    ...
    anlsD = anlzDcentsph(ds, anlsD, [500, 1000, 2000], ['tele', 'magtot', 'KEdens', 'Pm'])
    anlsD = anlzDcentcube(ds, anlsD, [1000, 2000, 4000], ['tele', 'magtot', 'KEdens', 'Pm'])
...
if __name__ == "__main__":
    ...
    fnpatt = os.path.join(datdir, basenm + 'hdf5_plt_cnt_??[0,2,4,6,8]0') # yt-time-series filename pattern for plot files
    # hdf5_plt_cnt_????
